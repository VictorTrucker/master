...
public class VTTPieceWorkFrame extends JFrame implements ActionListener
{
  ...
  private JMenuItem
    ...
    menuEditFont  = new JMenuItem( "Select Font" ),
  ...
  public void actionPerformed( ActionEvent e )
  {
    ...
    else if ( e.getSource() == menuEditFont )
    {
      statusBar.setText( " Set Font for the Output Text" );
      editFont();
    }
  ...
  public void editClear()
  {
    ...
    txtPieces.setText( "0" );
    worker.strWorker = "No Name";

    for ( nLup = 0; nLup < worker.nPieces.length; nLup++ )
    {
      worker.nPieces[nLup] = 0;
      worker.dAmount[nLup] = 0.00;
    }
  ...
  {
    VTTFontChooser
      dlg = new VTTFontChooser( this, font );
    Dimension
      frmSize = getSize(),
...
//    dlg.currentFont = font;
  ...
  private void addListeners()
  {
    ...
    menuEditFont.addActionListener( this );
