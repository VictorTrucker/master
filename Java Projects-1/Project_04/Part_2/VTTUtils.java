...
//      strDbls = new String( "-0123456789." ),
    ...
    if ( strVal == null ) System.exit( 0 );

//    for ( nLup = 0; nLup < strVal.length(); nLup++ )
//    {
//      chTest = strVal.charAt( nLup );
//      switch ( nType )
//      {
//        case GET_INTEGER:
//          if ( strInts.indexOf( chTest ) < 0 ) strVal = "";
//          break;
//        case GET_DOUBLE:
//          if ( strDbls.indexOf( chTest ) < 0 ) strVal = "";
//          if ( strVal.indexOf( '.' ) != strVal.lastIndexOf( '.' ) ) strVal = "";
//          break;
//      }
//    }
      switch ( nType )
